    ...
    return (
        <main className={styles.main}>
            ...
            <nav className={styles.nav}>
                ...
                <a href="/api/auth/google" className={`${styles.navLink} ${styles.navLinkPrimary}`}>
                    Sign in with Google
                </a>
            </nav>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroCta}>
                    <a href="/api/auth/google" className={styles.ctaPrimary}>
            ...
            <div className={styles.features}>
                <div className={styles.featureCard}>
                    ...
                    <div className={styles.featureTitle}>Google Verified</div>
                    <p className={styles.featureDesc}>
                        Sign in securely with your Google account — one tap, no passwords to remember.
                    </p>
                </div>
                <div className={styles.featureCard}>
